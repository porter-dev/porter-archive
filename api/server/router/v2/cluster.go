...
func NewV2ClusterScopedRegisterer(children ...*router.Registerer) *router.Registerer {
	return &router.Registerer{
		GetRoutes: GetV2ClusterScopedRoutes,
		Children:  children,
	}
}

func GetV2ClusterScopedRoutes(
	r chi.Router,
	...
	routes, projPath := getV2ClusterRoutes(r, config, basePath, factory)
...
func getV2ClusterRoutes(
	...
	// POST /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces -> cluster.NewCreateNamespaceHandler
	// swagger:operation POST /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces createNamespace
	//
	...
	// GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace} -> cluster.NewGetNamespaceHandler
	// swagger:operation GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace} getNamespace
	//
	...
	// GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces -> cluster.NewListNamespacesHandler
	// swagger:operation GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces listNamespaces
	//
	...
	// DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace} -> cluster.NewDeleteNamespaceHandler
	// swagger:operation DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace} deleteNamespace
	//
