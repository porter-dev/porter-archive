...
import (
	...
	v2EnvGroup "github.com/porter-dev/porter/api/server/handlers/v2/env_group"
...
func NewV2EnvGroupScopedRegisterer(children ...*router.Registerer) *router.Registerer {
	return &router.Registerer{
		GetRoutes: GetV2EnvGroupScopedRoutes,
		Children:  children,
	}
}

func GetV2EnvGroupScopedRoutes(
	r chi.Router,
	...
	routes, projPath := getV2EnvGroupRoutes(r, config, basePath, factory)
...
func getV2EnvGroupRoutes(
	...
	// PUT /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups -> namespace.NewCreateEnvGroupHandler
	// swagger:operation PUT /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups createOrUpdateEnvGroup
	//
	...
	//     schema:
	//       $ref: '#/definitions/V2EnvGroupResponse'
	//   '403':
	...
	createOrUpdateEnvGroupHandler := v2EnvGroup.NewCreateEnvGroupHandler(
		config,
	...
	// GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name}/versions/{version} -> env_group.NewGetEnvGroupHandler
	// swagger:operation GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name}/versions/{version} getEnvGroup
	//
	...
	getEnvGroupHandler := v2EnvGroup.NewGetEnvGroupHandler(
		config,
		factory.GetDecoderValidator(),
		factory.GetResultWriter(),
	)
	...
	// GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name} -> env_group.NewGetEnvGroupAllVersionsHandler
	// swagger:operation GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name} getEnvGroupAllVersions
	//
	...
	//     description: Successfully fetched the env group
	//     schema:
	//       $ref: '#/definitions/V2EnvGroupsAllVersionsResponse'
	//   '403':
	//     description: Forbidden
	//   '404':
	//     description: Env group not found
	...
	getEnvGroupAllVersionsHandler := v2EnvGroup.NewGetEnvGroupAllVersionsHandler(
		config,
		factory.GetDecoderValidator(),
		factory.GetResultWriter(),
	)
	...
	// GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups -> namespace.NewListEnvGroupsHandler
	// swagger:operation GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups listAllEnvGroups
	//
	...
	//     description: Successfully fetched the env group
	//     schema:
	//       $ref: '#/definitions/V2ListAllEnvGroupsResponse'
	//   '403':
	//     description: Forbidden
	...
	listEnvGroupsHandler := v2EnvGroup.NewListEnvGroupsHandler(
		config,
		factory.GetResultWriter(),
	)
	...
	// DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name} -> env_group.NewDeleteEnvGroupHandler
	// swagger:operation DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name} deleteEnvGroup
	//
	...
	deleteEnvGroupHandler := v2EnvGroup.NewDeleteEnvGroupHandler(
		config,
		factory.GetDecoderValidator(),
		factory.GetResultWriter(),
	)
	...
	// PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name}/add_release -> env_group.NewAddReleaseToEnvGroupHandler
	// swagger:operation PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name}/add_release addReleaseToEnvGroup
	//
	...
	//   - name: name
	//   - in: body
	//     name: V2EnvGroupReleaseRequest
	//     description: The name of the release to add
	//     schema:
	//       $ref: '#/definitions/V2EnvGroupReleaseRequest'
	// responses:
	//   '200':
	...
	addReleaseToEnvGroupHandler := v2EnvGroup.NewAddReleaseToEnvGroupHandler(
		config,
		factory.GetDecoderValidator(),
		factory.GetResultWriter(),
	)
	...
	// PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name}/remove_release -> env_group.NewRemoveReleaseFromEnvGroupHandler
	// swagger:operation PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/env_groups/{name}/remove_release removeReleaseFromEnvGroup
	//
	...
	removeReleaseFromEnvGroupHandler := v2EnvGroup.NewRemoveReleaseFromEnvGroupHandler(
		config,
		factory.GetDecoderValidator(),
		factory.GetResultWriter(),
	)
