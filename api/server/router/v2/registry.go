...
import (
	...
	v2Registry "github.com/porter-dev/porter/api/server/handlers/v2/registry"
...
func NewV2RegistryScopedRegisterer(children ...*router.Registerer) *router.Registerer {
	return &router.Registerer{
		GetRoutes: GetV2RegistryScopedRoutes,
		Children:  children,
	}
}

func GetV2RegistryScopedRoutes(
	r chi.Router,
	...
	routes, projPath := getV2RegistryRoutes(r, config, basePath, factory)
...
func getV2RegistryRoutes(
	...
	// POST /api/v2/projects/{project_id}/registries -> registry.NewRegistryCreateHandler
	// swagger:operation POST /api/v2/projects/{project_id}/registries createRegistry
	//
	...
	// GET /api/v2/projects/{project_id}/registries/{registry_id} -> registry.NewRegistryGetHandler
	// swagger:operation GET /api/v2/projects/{project_id}/registries/{registry_id} getRegistry
	//
	...
	// GET /api/v2/projects/{project_id}/registries -> registry.NewRegistryListHandler
	// swagger:operation GET /api/v2/projects/{project_id}/registries listRegistries
	//
	...
	// DELETE /api/v2/projects/{project_id}/registries/{registry_id} -> registry.NewRegistryDeleteHandler
	// swagger:operation DELETE /api/v2/projects/{project_id}/registries/{registry_id} deleteRegistry
	//
	...
	// POST /api/v2/projects/{project_id}/registries/{registry_id}/repositories -> registry.NewRegistryCreateRepositoryHandler
	// swagger:operation POST /api/v2/projects/{project_id}/registries/{registry_id}/repositories createRegistryRepository
	//
	...
	// GET /api/v2/projects/{project_id}/registries/{registry_id}/repositories -> registry.NewRegistryListRepositoriesHandler
	// swagger:operation GET /api/v2/projects/{project_id}/registries/{registry_id}/repositories listRegistryRepositories
	//
	...
	// GET /api/v2/projects/{project_id}/registries/{registry_id}/repositories/* -> registry.NewRegistryListImagesHandler
	// swagger:operation GET /api/v2/projects/{project_id}/registries/{registry_id}/repositories/{repository} listRegistryImages
	//
	...
	//     schema:
	//       $ref: '#/definitions/V2ListImageResponse'
	//   '400':
	//     description: A malformed or bad request
	//   '403':
	//     description: Forbidden
	...
	listImagesHandler := v2Registry.NewRegistryListImagesHandler(
		config,
		factory.GetDecoderValidator(),
		factory.GetResultWriter(),
	)
