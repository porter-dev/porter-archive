...
import (
	...
	v2Release "github.com/porter-dev/porter/api/server/handlers/v2/release"
...
func NewV2ReleaseScopedRegisterer(children ...*router.Registerer) *router.Registerer {
	return &router.Registerer{
		GetRoutes: GetV2ReleaseScopedRoutes,
		Children:  children,
	}
}

func GetV2ReleaseScopedRoutes(
	r chi.Router,
	...
	routes, projPath := getV2ReleaseRoutes(r, config, basePath, factory)
...
func getV2ReleaseRoutes(
	...
	// POST /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases -> release.NewCreateReleaseHandler
	// swagger:operation POST /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases createRelease
	//
	...
	// GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases/{name}/{version} -> release.NewReleaseGetHandler
	// swagger:operation GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases/{name}/{version} getRelease
	//
	...
	// GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases -> namespace.NewListReleasesHandler
	// swagger:operation GET /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases listReleases
	//
	...
	// PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases/{name}/{version} ->
	// release.NewUpgradeReleaseHandler
	// swagger:operation PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases/{name}/{version} updateRelease
	//
	...
	upgradeHandler := v2Release.NewUpgradeReleaseHandler(
		config,
		factory.GetDecoderValidator(),
		factory.GetResultWriter(),
	)
	...
	// DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases/{name}/{version} ->
	// release.NewDeleteReleaseHandler
	// swagger:operation DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}/namespaces/{namespace}/releases/{name}/{version} deleteRelease
	//
