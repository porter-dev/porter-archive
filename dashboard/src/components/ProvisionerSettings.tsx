...
const ProvisionerSettings: React.FC<Props> = (props) => {
  ...
  const [
    initialKmsEncryptionEnabled,
    setInitialKmsEncryptionEnabled,
  ...
  useEffect(() => {
    ...
    if (contract?.cluster) {
      ...
      setInitialKmsEncryptionEnabled(eksValues.enableKmsEncryption);
        ...
        {isExpanded && (
          <>
            ...
            <Checkbox
              ...
              disabled={isReadOnly || initialKmsEncryptionEnabled}
              toggleChecked={() => {
                setKmsEncryptionEnabled(!kmsEncryptionEnabled);
              }}
            >
              <Text color="helper">
                Enable KMS Encryption for this cluster. This will encrypt all
