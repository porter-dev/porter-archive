...
const BuildEventFocusView: React.FC<Props> = ({ event }) => {
  ...
  const getBuildLogs = async () => {
    if (
      event == null ||
      porterApp.git_repo_id == null ||
      porterApp.repo_name == null ||
      event.metadata.action_run_id == null
    ) {
      return;
    }
    try {
                ...
                if (
                  ...
                  for (let i = 0; i < lines.length; i++) {
                    ...
                    const lineWithoutTimestamp = line
                      ...
                      .trimStart();
                    const anserLine: AnserJsonEntry[] =
                      Anser.ansiToJson(lineWithoutTimestamp);
