 ...
 *
 */
const OryLogin = (): JSX.Element => {
    const { authenticate } = useContext(AuthnContext)
            ...
            additionalProps={{
                forgotPasswordURL: {
                    handler: () => {
                        ...
                        console.log("forgot", `${basePath}/ui/recovery?${search.toString()}`)
                ...
                signupURL: {
                    handler: () => {
                        ...
                        console.log("signup", `${basePath}/ui/registration?${search.toString()}`)
