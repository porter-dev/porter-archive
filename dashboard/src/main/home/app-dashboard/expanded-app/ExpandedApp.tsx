      ...
      if (
        ...
        await api.createPorterApp(
          "<token>",
          {
            ...
            builder: !_.isEmpty(tempPorterApp.dockerfile) || !_.isEmpty(tempPorterApp.image_repo_uri) ? "" : tempPorterApp.builder,
            buildpacks: !_.isEmpty(tempPorterApp.dockerfile) || !_.isEmpty(tempPorterApp.image_repo_uri) ? "" : tempPorterApp.buildpacks.join(","),
