...
const MetricsSection: React.FunctionComponent<PropsType> = ({
  ...
  const setSelectedServiceOption = (option: ServiceOption) => {
      console.log("setSelectedServiceOption: ", option)
  ...
  const { data: metricsData, isLoading: isMetricsDataLoading, refetch } = useQuery(
    ...
    async () => {
      ...
      for (const metricType of metricTypes) {
        ...
        console.log("aggregatedMetricsResponse: ", aggregatedMetricsResponse)
        // TODO: type the response to this
          console.log("input: ", { results: (aggregatedMetricsResponse.data ?? []).flatMap((d: any) => d.results) })
