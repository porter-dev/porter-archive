...
const ProvisionerSettings: React.FC<Props> = (props) => {
        ...
        {currentProject && (
          <>
            ...
            <FlexCenter>
              ...
              >
                <Text color="helper">Enable ECR scanning for this cluster</Text>
              </Checkbox>
            </FlexCenter>
            <Spacer y={1} />
            ...
            <FlexCenter>
              ...
              >
                <Text color="helper">
                  Install AWS GuardDuty agent on this cluster (see details to
                  fully enable)
                </Text>
                <Spacer x={0.5} inline />
                <Tooltip
  ...
  return (
    <>
      <StyledForm>{renderAdvancedSettings()}</StyledForm>
      <Button
        // disabled={isDisabled()}
