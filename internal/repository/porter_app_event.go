...
type PorterAppEventRepository interface {
	...
	ListEventsByPorterAppIDExcludingAppEvents(ctx context.Context, porterAppID uint, opts ...helpers.QueryOption) ([]*models.PorterAppEvent, helpers.PaginatedResult, error)
