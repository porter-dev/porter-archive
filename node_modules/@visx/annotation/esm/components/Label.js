...
export default function Label(_ref) {
  ...
  return !title && !subtitle ? null : /*#__PURE__*/React.createElement(Group, {
    ...
    y1: 0,
    y2: height
  }))), title && /*#__PURE__*/React.createElement(Text // @ts-ignore useMeasure expects HTML ref
  , _extends({
    innerRef: titleRef,
    fill: fontColor,
  ...
  }, titleProps), title), subtitle && /*#__PURE__*/React.createElement(Text // @ts-ignore useMeasure expects HTML ref
  , _extends({
