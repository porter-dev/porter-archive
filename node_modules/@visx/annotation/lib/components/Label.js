...
function Label(_ref) {
  ...
  return !title && !subtitle ? null : /*#__PURE__*/_react.default.createElement(_Group.default, {
    ...
    width: width,
    height: height
  }, backgroundProps)), showAnchorLine && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, anchorLineOrientation === 'horizontal' && verticalAnchor === 'start' && /*#__PURE__*/_react.default.createElement("line", _extends({}, backgroundOutline, {
    x1: 0,
    x2: width,
    y1: 0,
    y2: 0
    ...
    y1: 0,
    y2: height
  }))), title && /*#__PURE__*/_react.default.createElement(_Text.default // @ts-ignore useMeasure expects HTML ref
  , _extends({
    innerRef: titleRef,
    fill: fontColor,
  ...
  }, titleProps), title), subtitle && /*#__PURE__*/_react.default.createElement(_Text.default // @ts-ignore useMeasure expects HTML ref
  , _extends({
